...
#define OS2      2    /* 1 = OS/2 1.x - 2 = OS/2 2.x                   */
...
#define ICC      1    /* IBM C/C++ Set 2.0 for IBM OS/2 2.x            */
...
#ifdef ICC       /* the IBM-Compiler uses nearly everything like          */
   #undef MSC    /* Microsofts Compiler, some differences are in OS2NPM.C */
   #define MSC 1 
#endif
...
#define OS2NPM    1            /* OS/2 non-Presentation Mgr.    */
...
typedef struct LINE {
    ...
    /* I'm wondering about the last type definition. Isn't unsigned char
     * a better choice for l_text? 
     * Question by Ralf Seidel */
} LINE;
